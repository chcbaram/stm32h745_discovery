...
#ifndef SRC_COMMON_HW_DXLCMD_H_
#define SRC_COMMON_HW_DXLCMD_H_
...
#define DXLCMD_MAX_NODE               HW_DXLCMD_MAX_NODE
#define DXLCMD_MAX_NODE_BUFFER_SIZE   HW_DXLCMD_MAX_NODE_BUFFER_SIZE
#define DXLCMD_MAX_BUFFER             HW_DXLCMD_BUFFER_MAX
