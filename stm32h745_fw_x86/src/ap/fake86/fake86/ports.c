...
uint8_t portram[0x10000] __attribute__((section(".sdram_buf")));

extern uint8_t speakerenabled;
extern uint8_t keyboardwaitack;

static bool _port_ignore[0x10000] __attribute__((section(".sdram_buf")));

static port_write_b_t port_write_callback[0x10000] __attribute__((section(".sdram_buf")));
static port_read_b_t port_read_callback[0x10000] __attribute__((section(".sdram_buf")));
...
void port_init(void) {
  ...
  memset(_port_ignore, 0, sizeof(_port_ignore));
